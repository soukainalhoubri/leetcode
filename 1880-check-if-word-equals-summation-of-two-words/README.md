...
<pre style="position: relative;"><strong>Input:</strong> firstWord = "acb", secondWord = "cba", targetWord = "cdb"
...
<pre style="position: relative;"><strong>Input:</strong> firstWord = "aaa", secondWord = "a", targetWord = "aab"
...
<pre style="position: relative;"><strong>Input:</strong> firstWord = "aaa", secondWord = "a", targetWord = "aaaa"
<strong>Output:</strong> true
<strong>Explanation:</strong> 
The numerical value of firstWord is "aaa" -&gt; "000" -&gt; 0.
The numerical value of secondWord is "a" -&gt; "0" -&gt; 0.
